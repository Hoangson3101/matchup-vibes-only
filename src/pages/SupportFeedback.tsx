    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link to="/messages">
            <Button className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white py-4 rounded-xl text-lg font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg">
              <MessageSquare className="mr-2 h-5 w-5" />
              Gửi tin nhắn hỗ trợ
            </Button>
          </Link>
          <Link to="/">
            <Button variant="outline" className="w-full py-4 rounded-xl text-lg font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg border-2 border-purple-200 hover:bg-purple-50">
